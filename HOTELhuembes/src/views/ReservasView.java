...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		logo.setBounds(191, 38, 150, 107);
		panel_1.add(logo);
		logo.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\Captura (1).jpg"));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 151, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\RELOJ.png"));
