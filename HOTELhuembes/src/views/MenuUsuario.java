...
public class MenuUsuario extends JFrame {
	 ...
	 */
	public MenuUsuario() {
		setIconImage(Toolkit.getDefaultToolkit().getImage("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\Captura (1).jpg"));
		...
		panelMenu.setBackground(new Color(0, 0, 102));
		...
		lblNewLabel_2.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\Captura (1).jpg"));
		...
		btnRegistro.setBackground(new Color(51, 0, 204));
		...
		btnBusqueda.setBackground(new Color(51, 153, 102));
		panelMenu.add(btnBusqueda);
		btnBusqueda.setLayout(null);
		
		JLabel lblBusquedaDeReservas = new JLabel("Búsqueda");
		lblBusquedaDeReservas.setBackground(new Color(51, 51, 204));
	    ...
	    panelFecha.setBackground(new Color(0, 0, 102));
	    panelFecha.setBounds(256, 84, 688, 121);
	    contentPane.add(panelFecha);
	    panelFecha.setLayout(null);
	    
	    JLabel lblNewLabel_1 = new JLabel("Sistema de reservas Hotel HUEMBES");
	    lblNewLabel_1.setBounds(156, 12, 442, 42);
	    ...
	    labelDescripcion.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 17));
	    ...
	    labelDescripcion_1.setFont(new Font("Yu Gothic UI Semibold", Font.PLAIN, 17));
