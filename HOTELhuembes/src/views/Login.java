...
public class Login extends JFrame {
	...
	public Login() {
		...
		lblNewLabel_1.setBounds(58, 170, 193, 190);
		panel_1.add(lblNewLabel_1);
		lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
		lblNewLabel_1.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\Captura (1).jpg"));
		...
		labelTitulo.setForeground(new Color(0, 153, 255));
		...
		JLabel imgHotel_1 = new JLabel("");
		imgHotel_1.setBounds(182, -85, 274, 291);
		panel.add(imgHotel_1);
		
		JLabel imgHotel = new JLabel("");
		imgHotel.setBounds(10, 32, 496, 495);
		panel.add(imgHotel);
		imgHotel.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\EDIFICIO2.png"));
	}
