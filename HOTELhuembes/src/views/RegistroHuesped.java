...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		lblTitulo.setForeground(new Color(51, 0, 102));
		...
		imagenFondo.setBounds(31, 154, 433, 502);
		panel.add(imagenFondo);
		imagenFondo.setIcon(new ImageIcon("C:\\Users\\50688\\Downloads\\HOTELHUEMBES\\HOTELhuembes\\ROBOTRESER.png"));
		
		JLabel logo = new JLabel("");
		logo.setBounds(178, 37, 150, 107);
		panel.add(logo);
